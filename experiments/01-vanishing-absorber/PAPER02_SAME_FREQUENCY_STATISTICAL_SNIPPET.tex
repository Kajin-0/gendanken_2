...
This comparison also clarifies the role of the deterministic full-vector residual quoted elsewhere in the paper: it is a descriptive approximation error, whereas Table~ef{tab:samefreq} is the corresponding covariance-aware model-selection statement for the reference noise model.
