...
**Canonical manuscript status:** the current approved manuscript baseline is the recovered **16-page Rev. 3** by Anonymous, immediately before the realistic 2-D geometry hardening result.
