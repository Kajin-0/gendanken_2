...
\caption{Root-space discrimination of the deterministic nuisance from homogeneous diffusion. Increasing usable RF bandwidth substantially reduces the channel SNR required for a fixed rejection power because the first unmatched frequency terms grow beyond the low-frequency tangent regime.}
\label{fig:snr}
\end{figure}
